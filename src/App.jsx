...
function App() {
  ...
  const [anuncio, setAnuncio] = useState("Bem-vindo ao DevLife Dashboard!");
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <a href="#concluido" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-50 focus:bg-white focus:text-slate-900 focus:px-4 focus:rounded-lg focus:shadow-lg">
